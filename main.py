...
# ---------------------------------- TRAINING ------------------------------
# Parameters
# weights = [1, 5, 1, 5, 0.1, 0.1, 0.1, 0.1, 1]  # weights for each feature
# best weights = [4, 15, 3, 0.5, 1, 0.1, 3, 2, 5] (0.7466756741705212) Using SVR
...
while 1:
    weights = [possible_weigths[random.randint(0,12)],possible_weigths[random.randint(0,12)],possible_weigths[
        random.randint(0,12)],possible_weigths[random.randint(0,12)],possible_weigths[random.randint(0,12)],
               possible_weigths[random.randint(0,12)],possible_weigths[random.randint(0,12)],possible_weigths[
                   random.randint(0,12)],possible_weigths[random.randint(0,12)]]
    n_components_LDA = 3
    ...
    # Classify
    best_result = prediction_labels(X_train,Y_train,X_test,Y_test,n_components_LDA, best_result, weights)
