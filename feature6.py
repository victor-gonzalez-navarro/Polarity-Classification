...
# Feature 6: Difference between the objectivity of both sentences


def compute_feature6(frases1, frases2, X_train_or_test):
    ...
    for item in text:
        ...
        if pairs[item][0].lower()== 'j':
            ...
            if synset != []:
                ...
                objectivity_score = objectivity_score + sentiSynset.pos_score() - sentiSynset.neg_score()
